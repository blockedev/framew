...
class Admin extends Model {
	...
	public function postValidate($post, $type) {
		...
		if ($nameLen < 3 or $nameLen > 100) {
			...
			$this->error = 'Опис повинен містити від 3 до 100 символів';
			return false;
		} elseif ($textLen < 10 or $textLen > 5000) {
			$this->error = 'Текст повинен містити від 10 до 5000 символів';
			return false;
		}
	...
	public function postAdd($post) {
		...
		$this->db->query('INSERT INTO `posts` VALUES (:id, :name, :description, :text, :status)', $params);
